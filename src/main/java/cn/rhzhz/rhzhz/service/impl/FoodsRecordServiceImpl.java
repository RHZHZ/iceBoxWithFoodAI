...
@Service
public class FoodsRecordServiceImpl implements FoodsRecordService {
    @Autowired
    ...
    @Override
    public List<FoodTypeCount> groupByType() {
        Map<String,Object> map = ThreadLocalUtil.get();
        Integer id = (Integer) map.get("id");
        return foodsMapper.groupByType(id);
    }
    ...
    @Override
    public void updateRecord(FoodRecord foodRecord) {
        foodsMapper.updateRecord(foodRecord);
    }

    @Override
    public boolean existsByUserAndNameAndDate(Integer userId, String name, LocalDate purchaseDate) {
        return foodsMapper.existsByUserAndNameAndDate(userId, name, purchaseDate);
    }

    @Override
    public void update(FoodRecord record) {
        foodsMapper.update(record);
    }

    @Override
    public List<FoodRecord> findByName(String foodName, int id) {
        return foodsMapper.findByName(foodName,id);
    }
